      ...
      <div className="fixed left-0 top-0 h-full w-80 max-w-sm bg-white shadow-xl">
        ...
        <div className="p-4">
          ...
          <button
            ...
            className="flex items-center w-full p-3 rounded-lg text-left hover:bg-gray-100 transition-colors"
          >
          ...
          {/* Exhibitions */}
          <div className="mt-6">
            <h3 className="text-sm font-semibold text-gray-700 mb-3 px-3">Ausstellungen</h3>
            <div className="space-y-1">
              {exhibitions.map((exhibition) => (
                <button
                  key={exhibition.id}
                  onClick={() => handleExhibitionClick(exhibition.id)}
                  className="flex items-start w-full p-3 rounded-lg text-left hover:bg-gray-100 transition-colors"
                >
                  <BookOpen className="h-5 w-5 mr-3 text-gray-600 mt-0.5 flex-shrink-0" />
                  <div>
