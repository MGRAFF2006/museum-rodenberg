          ...
          <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-primary-800 text-white rounded-lg hover:bg-primary-700 transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-neutral-200 text-neutral-800 rounded-lg hover:bg-neutral-300 transition-colors"
              >
